...
public class add_product {
		...
		public void adds_product_by_providing_details() {
			...
			response = request.when().post("/add-shoe?id=101&image=image_url&name=SampleShoe&category=Running&sizes=9&price=1000");

		}


		@Then("validate post request outcomes status code is {int}")
